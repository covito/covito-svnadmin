...
<form name="pj" action="<%=ctx%>/pj" method="post" onsubmit="return checkForm(this);">
	...
	<table class="table table-striped table-bordered">
		...
		<tr>
			...
			<td colspan="5"><input type="text" name="des" value="<%=entity.getDes()==null?"":entity.getDes()%>" style="width:98%;"></td>
		</tr>
		<tr>
			<td colspan="6" align="center" style="text-align: center;">
				<input type="submit" class="btn btn-primary" value="<%=I18N.getLbl(request,"pj.btn.submit","提交") %>">
			</td>
		</tr>
	</table>
</form>
