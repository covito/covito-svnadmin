...
<table style="width:100%;height:80%;" class="table table-striped table-bordered">
	<tr>
		<td valign="top" style="width:300px;">
			<input type="text" style="width:210px;" id="path" value="<%=request.getAttribute("path")%>">　<input onclick="freshTree();" class="btn btn-primary" type="button" value="<%=I18N.getLbl(request, "rep.btn.go", "刷新")%>">
