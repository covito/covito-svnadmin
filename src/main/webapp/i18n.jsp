			...
			<form name="i18n" action="<%=ctx%>/i18n" method="post" onsubmit="return checkForm(this);">
				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td>
						   	<input style="width:98%;" type="text" name="lbl_<%=i%>" value="<%=(entitys==null || entitys.get(lang)==null)?"":entitys.get(lang).getLbl()%>" >
						</td>
					</tr>
					<%} %>
					<tr>
						<td colspan="2" align="center">
							<input type="submit" class="btn btn-primary" value="<%=I18N.getLbl(request,"i18n.op.submit","提交") %>">
							&nbsp;&nbsp;
